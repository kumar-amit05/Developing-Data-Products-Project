---
title: 'Course Project: Shiny Application and Reproducible - Diamond Price Prediction'
author: "Amit kumar"
...
## Overview
This presentation contains documentation for the Diamond price prediction application. The application can be found [here](https://kumar-amit0502.shinyapps.io/myapp/)
...
- `ui.R` [View](https://github.com/kumar-amit05/Developing-Data-Products-Project/blob/master/ui.R)
- `server.R` [View](https://github.com/kumar-amit05/Developing-Data-Products-Project/blob/master/server.R)

Both files can be found here: [GitHub repo](https://github.com/kumar-amit05/Developing-Data-Products-Project)
